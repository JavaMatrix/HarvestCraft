...
public class LettucePlant extends BlockCrops
{
	...
	{
		return HarvestCraft.LettuceSeeds.itemID;
	}
	
	protected int getCropItem()
	{
		return HarvestCraft.Lettuce.itemID;
	}
	...
	public void registerIcons(IconRegister iconRegister)
	{
		...
		{
			this.iconArray[i] = iconRegister.registerIcon("harvestcraft:Lettuce_"+i);
		}
	}
}
