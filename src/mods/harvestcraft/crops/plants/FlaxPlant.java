...
public class FlaxPlant extends BlockCrops
{
	...
	{
		return HarvestCraft.FlaxSeeds.itemID;
	}
	
	protected int getCropItem()
	{
		return HarvestCraft.Flax.itemID;
	}
	...
	public void registerIcons(IconRegister iconRegister)
	{
		...
		{
			this.iconArray[i] = iconRegister.registerIcon("harvestcraft:Flax_"+i);
		}
	}
}
