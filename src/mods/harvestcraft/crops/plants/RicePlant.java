...
public class RicePlant extends BlockCrops
{
	...
	{
		return HarvestCraft.RiceSeeds.itemID;
	}
	
	protected int getCropItem()
	{
		return HarvestCraft.Rice.itemID;
	}
	...
	public void registerIcons(IconRegister iconRegister)
	{
		...
		{
			this.iconArray[i] = iconRegister.registerIcon("harvestcraft:Rice_"+i);
		}
	}
}
